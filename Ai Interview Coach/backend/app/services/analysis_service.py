...
# ---------- Groq LLM Feedback ----------
def generate_llm_feedback(temporal, fluency, lexical, acoustic, scores, transcript, resume_text=""):
    try:
...
def generate_feedback(temporal, fluency, lexical, acoustic, scores, words, transcript="", resume_text=""):
    """
    ...
    llm_feedback = generate_llm_feedback(temporal, fluency, lexical, acoustic, scores, transcript, resume_text)
